                ...
                <div className="container d-flex flex-column justify-content-center align-items-center py-5">
                    ...
                    <div className="row justify-content-between align-items-center">
                        <div className="col-lg-6 col-md-6 mt-3 p-5">
                            <h3 className="mb-2 reveal__text">1. Visual Alignment</h3>
                    ...
                    <div className="row justify-content-between align-items-center">
                        <div className="col-lg-6 col-md-6 mt-3 p-5">
                            <h3 className="mb-2 reveal__text">2. Homepage Design</h3>
                            <p className='fade__up__text'>
                    ...
                    <div className="row justify-content-between align-items-center">
                        <div className="col-lg-6 col-md-6 mt-3 p-5">
                            <h3 className="mb-2 reveal__text">3. Additional Pages Design & Development</h3>
                            <p className='fade__up__text'>
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 mt-3 p-5">
                            <div className="price__card p-lg-5 p-md-5 p-3">
                                <div className="pill px-3 py-1">
                                    <small className='fade__text'>Branding + Web Design</small>
                                </div>
                                <h4 className='mt-4 reveal__text'>Landing Page or Mini Site (1-4 pages)</h4>
                                <p className="mt-3 fade__text">For startups that want to quickly explore a new
                                visual direction on their website.</p>
                                <p className="mt-3 fade__text">A completely new homepage design.</p>
                                <p className="mt-3 fade__text">Updated typography, colors and layout.</p>
                                <p className="mt-3 fade__text">Up to 3 iterative concept directions.</p>
                                <p className="mt-3 fade__text">3-4 supplemental marketing illustrations.</p>
                                <p className="mt-3 fade__text">Figma file deliverable, ready for dev.</p>
                                <p className="mt-3 fade__text">Webflow dev add on available (+$2,000)</p>
                        ...
                        <div className="col-lg-6 col-md-6 mt-3 p-5">
                            <div className="price__card p-lg-5 p-md-5 p-3 h-100 d-flex flex-column justify-content-between align-items-start">
                                ...
                                <div>
                                    <h4 className='mt-4 reveal__text'>E-com or Enterprise Site (5-15 pages)</h4>
                                    <p className="mt-3 fade__text">For early stage teams that need a brand refresh, a few essential page designs, and web style guide.</p>
                                    <p className="mt-3 fade__text">6 essential page designs</p>
                                    <p className="mt-3 fade__text">Reusable block-based sections</p>
                                    <p className="mt-3 fade__text">Web style guide</p>
                                    <p className="mt-3 fade__text">Figma file deliverable, ready for dev</p>
                                    <p className="mt-3 fade__text">Webflow dev add on available (+$5,000)</p>
                    ...
                    <div className="testimonial d-flex flex-column justify-content-center align-items-center mb-5">
                        ...
                        <div className="client d-flex">
                            ...
                            <div className="d-flex flex-column justify-content-around">
                                <h6 className='fade__up__text'>Bernard Barouch</h6>
                                <small className='fade__text'>Founder, Chronotype</small>
                            </div>
                        </div>
                    </div>
                    <div className="testimonial d-flex flex-column justify-content-center align-items-center mb-5">
                        ...
                        <div className="client d-flex">
                            ...
                            <div className="d-flex flex-column justify-content-around">
                                ...
                                <small className='fade__text'>Founder, CEO, Sugar Security</small>
                            </div>
                        </div>
                    </div>
                    <div className="testimonial d-flex flex-column justify-content-center align-items-center mb-5">
                        ...
                        <div className="client d-flex">
                            ...
                            <div className="d-flex flex-column justify-content-around">
                                ...
                                <small className='fade__text'>Founder, Head Q</small>
                            </div>
                        </div>
                    </div>
                </div>
