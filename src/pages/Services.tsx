        ...
        <div className='services__page'>
            <section className="hero__section">
                <div className="container d-flex flex-column justify-content-center align-items-center p-5 text-center">
                    <h1>
                        A modern design agency  <span className="purple">helping</span>
                        <br />
                        early-stage B2B startups look and 
                        <br />
                        feel like established players.
                    </h1>
            ...
            <section className="the__problem py-5">
                <div className="container d-flex flex-column justify-content-center align-items-center py-5">
                    ...
                    <h2 className="text-center mb-5">
                        ...
                        <br /> 
                        competitive edge while clearing any and all doubts 
                        <br />
                        about if your company is the right choice 
                    </h2>

                    <div className="row align-items-center">
                        <div className="col-lg-4 col-md-6 mt-lg-5 mt-3 p-5">
                            <h6>
            ...
            <section className="our__solution py-5">
                <div className="container d-flex flex-column justify-content-center align-items-center py-5">
                    ...
                    <h2 className="text-center">
                        We help start-ups and established 
                        <br />
                        companies bring a fresh and unmatched 
                        <br />
                        perspective to their websites  
                    </h2>

                    <div className="row justify-content-between align-items-center">
                        <div className="col-lg-6 col-md-6 mt-3 p-5">
                            <h2 className="mb-2">1. Visual Alignment</h2>
                            <p>
                    ...
                    <div className="row justify-content-between align-items-center">
                        <div className="col-lg-6 col-md-6 mt-3 p-5">
                            <h2 className="mb-2">2. Homepage Design</h2>
                            <p>
                    ...
                    <div className="row justify-content-between align-items-center">
                        <div className="col-lg-6 col-md-6 mt-3 p-5">
                            <h2 className="mb-2">3. Additional Pages Design & Development</h2>
                            <p>
                ...
                <div className="container py-5">
                    <div className="d-flex flex-column justify-content-center align-items-center ">  
                        ...
                        <h2 className="text-center mb-3">
                            We have created a flexible plan for companies seeking
                            <br />
                            a first time design or redesign   
                        </h2>
                    </div>
