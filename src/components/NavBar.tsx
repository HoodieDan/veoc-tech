...
function NavBar() {
    const {
        isOpen: isServiceNavOpen,
        open: openServiceNav,
        close: closeServiceNav,
    } = useServiceNav();
        ...
        <Fragment>
            <nav>
                <div className="container nav d-flex align-items-center justify-content-between">
                    ...
                    <NavLink
                        to="/"
                        className="d-flex logo align-items-center nav-link"
                    >
                    ...
                    <div className="mid-links d-flex align-items-center">
                        ...
                        <div
                            ...
                            onMouseEnter={openServiceNav}
                            onMouseLeave={closeServiceNav}
                        >
                            <span>Services</span>

                            {/* Service Navigation*/}
                            <ServiceNav isOpen={isServiceNavOpen} />
                        </div>
